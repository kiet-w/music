      ...
      <Card className="w-full max-w-sm border-none shadow-none bg-transparent sm:border sm:shadow-sm sm:bg-card">
        <CardHeader className="space-y-4 text-center pb-8">
          ...
          <div className="space-y-1">
            <CardTitle className="text-2xl font-serif italic tracking-tight">{t('login')}</CardTitle>
        ...
        <CardFooter className="flex flex-col space-y-4 pt-6 text-center text-[13px]">
          ...
          <p className="text-muted-foreground">
            {t('no_account')}{' '}
            <Link href={`/${locale}/register`} className="text-primary hover:underline font-semibold transition-all">
              {t('register')}
            </Link>
          </p>
        </CardFooter>
