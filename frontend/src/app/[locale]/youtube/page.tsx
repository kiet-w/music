    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6 transition-colors duration-500">
      <div className="max-w-2xl w-full bg-white/70 dark:bg-gray-800/60 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 shadow-2xl rounded-3xl p-8 md:p-12 transition-all duration-300 hover:shadow-cyan-500/10 text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 mb-6">
          Hệ thống tải nhạc đã nâng cấp!
        </h1>

        <div className="space-y-4 text-gray-600 dark:text-gray-300 text-lg mb-8 max-w-lg mx-auto">
          <p>
            Trang chuyển đổi YouTube cũ sử dụng API dịch vụ Python (cổng 8001) đã được thay thế hoàn toàn bằng trình tải nhạc hợp nhất sử dụng NestJS backend kết hợp hàng đợi hàng BullMQ hiệu năng cao.
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Giờ đây, bạn có thể tải nhạc YouTube trực tiếp ngay trong giao diện trang Music của bạn với độ ổn định vượt trội và tốc độ tải aria2c cực nhanh.
          </p>
        </div>
        ...
        <div className="mt-8 flex justify-center items-center gap-2 text-xs text-gray-400 dark:text-gray-500">
          ...
          <span>Unified NestJS Downloader Pipeline Enabled</span>
        </div>
