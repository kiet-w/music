      ...
      <div className="w-full max-w-[400px] relative z-10 space-y-10">
        <header className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-instrument italic tracking-tighter text-foreground">{t('register')}</h1>
            <p className="text-sm text-muted-foreground font-sans">{t('register_button')}</p>
          </div>
        </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground/60 group-focus-within:text-primary transition-colors" strokeWidth={1.5} />
                <Input
                  type="text"
                  placeholder={t('name')}
