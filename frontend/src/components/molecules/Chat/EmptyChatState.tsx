    ...
    <div className={cn("flex-1 p-6 flex flex-col items-center justify-center text-center my-auto", className)}>
      ...
      {firstUser && onSelectUser && (
        <Button
          ...
          className="bg-white hover:bg-zinc-200 text-black font-semibold text-xs px-4 py-2 rounded-xl flex items-center gap-2 transition-all active:scale-95 shadow-md shadow-white/10"
        >
