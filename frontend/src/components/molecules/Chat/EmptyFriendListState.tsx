    ...
    <div className={cn("flex-1 p-6 sm:p-10 flex flex-col items-center justify-center text-center my-auto", className)}>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Button
          ...
          className="bg-white hover:bg-zinc-200 text-black font-bold rounded-2xl text-sm px-5 py-3 h-12 flex items-center gap-2.5 shadow-lg shadow-white/10 transition-all active:scale-95"
        >
