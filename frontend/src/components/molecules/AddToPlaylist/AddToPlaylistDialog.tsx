              ...
              {albums && albums.length > 0 ? (
                albums.map((album) => (
                  ...
                  >
                    ...
                    {selectedId === album.id && <Check className="w-5 h-5 text-white shrink-0" />}
                  </button>
                ))
              ) : (
              ...
              <form onSubmit={handleCreateNewAlbum} className="flex flex-col gap-3 pt-3 border-t border-white/10 overflow-y-auto max-h-72 scrollbar-hide">
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white/5 rounded-xl border border-white/15 text-white placeholder:text-white/30 focus:outline-none focus:border-white/50 text-sm font-medium"
                    required
                    autoFocus
                  />
                </div>
                ...
                <div className="flex justify-end gap-2 mt-1">
                  ...
                  <button
                    ...
                    className="px-5 py-2 bg-white hover:bg-white/90 text-black font-bold rounded-xl text-xs transition-all flex items-center gap-1.5 shadow-md shadow-white/10 disabled:opacity-50 cursor-pointer"
                  >
