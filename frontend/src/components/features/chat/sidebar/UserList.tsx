        ...
        return (
          <button
            ...
            className={cn(
              ...
              activeUserId === user.id 
                ? "glass-light text-white shadow-soft ring-1 ring-white/30 bg-white/10" 
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-white/20 to-white/5 flex items-center justify-center font-bold text-white border border-white/10 relative shrink-0">
              ...
              {isUnread ? (
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-white rounded-full border-2 border-[#121212] shadow-sm animate-pulse" />
              ) : (
                <span 
                  className={cn(
            ...
            {isUnread && (
              <div className="bg-white/20 text-white text-[10px] px-2 py-0.5 rounded-full font-bold">
                NEW
              </div>
            )}
          </button>
