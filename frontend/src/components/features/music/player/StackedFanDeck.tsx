...
// ponytail: half-overlapping straight vertical stacked deck with drag & drop reordering (kiểu stack xếp gối 1 nửa + kéo thả)
...
export function StackedFanDeck({ onClose }: StackedFanDeckProps) {
  ...
  const containerHeight = Math.min(displayQueue.length * HALF_STACK_STEP + 48, 240);
    ...
    <div className="w-full flex flex-col gap-3 p-4 sm:p-5 bg-zinc-950/95 border border-white/15 rounded-[2.5rem] shadow-2xl backdrop-blur-2xl text-white overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-white/10 pb-2.5 px-1">
        ...
        <p className="text-[10px] text-zinc-400 font-mono uppercase tracking-wider">
          Xếp gối 1/2 • Kéo dọc đổi vị trí
        </p>
      </div>
      ...
      <div
        ...
        className="relative w-full my-1 px-1 flex items-center justify-center overflow-hidden transition-all"
      >
