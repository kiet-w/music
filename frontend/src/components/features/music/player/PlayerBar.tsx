...
export default function PlayerBar() {
  ...
  return (
    // ponytail: PlayerBar always centered, Stack pops out to the left via absolute positioning
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-[calc(100%-2rem)] max-w-[420px]">
      {/* --- STACKED CARDS DECK — absolutely positioned to the LEFT of player bar --- */}
      <div className="absolute bottom-0 right-[calc(100%+12px)]">
        <StackedFanDeck
      ...
      {/* --- MASTER PLAYER BAR (always centered) --- */}
